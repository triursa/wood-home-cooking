...
- `/recipes` — Markdown recipe cards with nutrition facts and health ratings
- `/meal-plans` — Weekly meal plans with grocery lists and batch cook schedules
- `/knowledge-base` — Dietary preferences, equipment notes, health guidelines

## Tech

- Hosted via **GitHub Pages** (Jekyll / Minima theme)
